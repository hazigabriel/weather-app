...
const fetchWeather = function(city, system){
	...
	if(location.protocol === "http:") {
 	...
 	fetch(`${protocol}//api.openweathermap.org/data/2.5/weather?q=${city}&appid=dd56feccf641467a3fb598d6e6f9ac6f&units=${system}`)
 		...
 		.then(function(response){
 			...
 			fetch(`${protocol}//api.openweathermap.org/data/2.5/onecall?lat=${response.coord.lat}&lon=${response.coord.lon}&exclude=minutely,hourly&appid=dd56feccf641467a3fb598d6e6f9ac6f&units=${system}`)
